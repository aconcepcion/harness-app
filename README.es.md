...
> Si usas un agente de programación — **Claude Code, Codex, Cursor, GitHub Copilot, OpenCode, Hermes Agent, Grok, Gemini CLI, Aider, o el propio dsh** — pégale esto y vete a por un café:
>
> ```
